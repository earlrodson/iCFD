              ...
              <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                {CATEGORIES.map(cat => (
                  <Link
                    ...
                    className="flex-shrink-0 flex flex-col items-center gap-1.5 px-3 py-3 rounded-2xl bg-card shadow-[0_1px_4px_rgba(0,0,0,0.07),0_0_1px_rgba(0,0,0,0.04)] min-w-[72px] text-center active:bg-muted transition-colors"
                  >
                    <CategoryIcon category={cat} className="h-5 w-5 text-primary" />
